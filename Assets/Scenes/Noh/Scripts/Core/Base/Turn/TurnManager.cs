...
public class TurnManager : Singleton<TurnManager>
{
    ...
    {
        turnEndObj.TurnEndAction = null; //턴종료가 끝낫으면 델리게이터를 초기화한다
    ...
    private void TurnEnddDeleteObj(ITurnBaseData deleteObject)
    {
    ...
    private void TurnAddSorting(ITurnBaseData addObject)
    {
