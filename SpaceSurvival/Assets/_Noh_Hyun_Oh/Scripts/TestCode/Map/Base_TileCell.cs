...
/// 타일 기본정보 
/// </summary>
public class Base_TileCell : Base_PoolObj ,ITileBase ,IPointerClickHandler ,IPointerUpHandler ,IPointerDownHandler
{
    /// <summary>
    /// 바닥에 깔릴 타일 타일교체시 필요 
    /// </summary>
    ...
    public void OnInitData(Vector3Int gridPos, CurrentTileState currentTileState)
    {
        lr.enabled = false;
